...
export default function WhyPage() {
  return (
    <div className="max-w-2xl mx-auto px-6 py-20">
      ...
      {/* Eyebrow */}
      <p className="text-xs font-semibold text-accent uppercase tracking-widest mb-4">Why we built this</p>

      {/* Opening */}
      <h1 className="text-4xl font-bold text-fg leading-tight mb-6">
      ...
      <hr className="border-line mb-16" />

      {/* Section 1 */}
      <section className="mb-16">
        <h2 className="text-xs font-semibold text-subtle uppercase tracking-widest mb-6">01 — A new kind of reader</h2>
      ...
      {/* Section 2 */}
      <section className="mb-16">
        <h2 className="text-xs font-semibold text-subtle uppercase tracking-widest mb-6">02 — What really happens</h2>
        ...
        <div className="bg-code border border-line rounded-xl p-6 mb-6 space-y-4">
          {[
            ...
            <div key={n} className="flex gap-4">
              <span className="text-xs font-mono text-line-dim shrink-0 mt-1">{n}</span>
              <p className="text-sm text-ghost leading-relaxed">{text}</p>
            </div>
          ))}
        </div>
      ...
      <section className="mb-16">
        <h2 className="text-xs font-semibold text-subtle uppercase tracking-widest mb-6">03 — The three bad options</h2>
        <p className="text-muted leading-relaxed mb-6">
        ...
        <div className="space-y-3 mb-6">
          {[
            ...
            <div key={title} className="bg-code border border-line rounded-lg p-4 flex gap-4">
              <span className="text-error text-sm mt-0.5 shrink-0">✕</span>
              <div>
                <p className="text-sm font-semibold text-subtle mb-1">{title}</p>
      ...
      <section className="mb-16">
        <h2 className="text-xs font-semibold text-subtle uppercase tracking-widest mb-6">04 — We've solved this before</h2>
        ...
        <div className="space-y-0 border border-line rounded-xl overflow-hidden">
          {[
            ...
            <div key={name} className={`p-5 ${i < arr.length - 1 ? "border-b border-line" : ""} ${accent ? "bg-accent/5" : "bg-code"}`}>
              <div className="flex items-baseline gap-3 mb-2">
                <span className="text-xs font-mono text-faint">{year}</span>
                <code className={`text-sm font-bold ${accent ? "text-accent" : "text-muted"}`}>{name}</code>
              </div>
              <p className="text-xs text-subtle mb-1">{what}</p>
              <p className="text-xs text-faint leading-relaxed">{why}</p>
            </div>
          ))}
        </div>
        ...
        <p className="text-muted leading-relaxed mt-6">
          ...
          That's exactly what <code className="text-accent text-sm">/ai</code> is designed to be.
        </p>
      </section>

      {/* Section 5 — What /ai is */}
      <section className="mb-16">
        <h2 className="text-xs font-semibold text-subtle uppercase tracking-widest mb-6">05 — What /ai actually is</h2>
        <p className="text-muted leading-relaxed mb-6">
          Simple: any service exposes <code className="text-accent text-sm">GET /ai</code> returning
        ...
        <div className="space-y-3 mb-6">
          {[
            ...
            <div key={q} className="bg-code border border-line rounded-lg p-4">
              <p className="text-sm text-muted font-medium mb-1">{q}</p>
              <p className="text-xs text-subtle leading-relaxed">{a}</p>
            </div>
          ))}
        </div>
        <p className="text-muted leading-relaxed">
      ...
      <section className="mb-16">
        <h2 className="text-xs font-semibold text-subtle uppercase tracking-widest mb-6">06 — Who this is for</h2>
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={who} className="bg-code border border-line rounded-xl p-5">
              <p className="text-sm font-semibold text-dim mb-3">{who}</p>
              <ul className="space-y-1.5">
                {benefits.map((b) => (
                  <li key={b} className="flex gap-2 text-xs text-subtle">
      ...
      <section className="mb-16">
        <h2 className="text-xs font-semibold text-subtle uppercase tracking-widest mb-6">07 — Where this goes</h2>
        <p className="text-muted leading-relaxed mb-4">
          Imagine a web where every service — every SaaS tool, every data API, every commerce platform —
          exposes <code className="text-accent text-sm">/ai</code>.
        </p>
        <p className="text-muted leading-relaxed mb-4">
      ...
      <div className="text-center">
        <p className="text-xs font-semibold text-accent uppercase tracking-widest mb-4">Join the movement</p>
        ...
        <p className="text-muted leading-relaxed mb-8">
          <code className="text-accent">/ai</code> is the same idea.
        ...
        <p className="mt-6 text-xs text-faint">
          ...
          <a href="https://github.com/aiendpoint/platform" className="text-accent hover:underline" target="_blank" rel="noopener noreferrer">

  ...
  return (
    ...
    >
      <div className="mb-2">
        ...
        {(service.webmcp || service.is_verified || service.source === "community") && (
          <div className="flex flex-wrap gap-1.5 mt-2">
            ...
            {service.source === "community" && (
              <span
                className="text-xs bg-purple/10 text-purple border border-purple/20 px-2 py-0.5 rounded-full"
                title="Auto-generated by AI agent — not verified by site owner"
              >
                community
              </span>
            )}
